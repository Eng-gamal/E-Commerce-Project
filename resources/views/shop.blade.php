              ...
              <div class="accordion-body px-0 pb-0 pt-3 category-list">
                <ul class="list list-inline mb-0">
                  ...
                  <li class="list-item">
                    ...
                    <span class="text-right float-end"> {{ optional($category->products)->count() }}</span>
        ...
        <div class="accordion" id="brand-filters">
          <div class="accordion-item mb-4 pb-3">
            ...
            <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
              ...
              <ul class="list list-inlin mb-0 brand-list">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size"  id="pagesize"name="pagesize" style="margin-right:20px;" >
              ...
              <option value="102"{{$size==102 ? 'selected':''}}>102</option>
                ...
                <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" name="orderdy"id="orderby">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{URL::asset('uploads/products/')}}/{{$product->image}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                        @foreach (explode(",",$product->images) as $gimg )
                      <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{URL::asset('uploads/products/')}}/{{$gimg}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                          @endforeach
                    </div>
                  </div>
                ...
                <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium "data-aside="cartDrawer" title="Add To Cart">Got To Cart</button>
                </form>
                @endif
              </div>
...
<script>
    ...
    let brands = ""; // استخدام let لتعريف المتغير
    $("input[name='brands']:checked").each(function() {
        if (brands === "") {
            brands += $(this).val(); // كتابة brands بشكل صحيح
        } else {
            brands += "," + $(this).val();
        }
    });
    $("#hdnBrands").val(brands); // تحديث القيمة المخفية
    $("#frmfilter").submit(); // إرسال النموذج
});

$("input[name='categories']").on("change", function() {
    let categories = ""; // استخدام let لتعريف المتغير
    $("input[name='categories']:checked").each(function() {
        if (categories === "") {
            categories += $(this).val(); // كتابة categories بشكل صحيح
        } else {
            categories += "," + $(this).val();
        }
    });
    $("#hdnCategories").val(categories); // تحديث القيمة المخفية
    $("#frmfilter").submit(); // إرسال النموذج
});
