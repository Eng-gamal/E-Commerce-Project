...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/animation.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/bootstrap.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/bootstrap-select.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/style.css')}}">
    <link rel="stylesheet" href="{{URL::asset('font/fonts.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/sweetalert.min.css')}}">
...
<body class="body">
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{ route('admin.index') }}" id="site-logo-inner">
                            <img class="logo" id="logo_header" alt="Logo" src="{{ URL::asset('images/logo/logo.png') }}"
                                 data-light="{{ URL::asset('images/logo/logo.png') }}"
                                 data-dark="{{ URL::asset('images/logo/logo.png') }}">
                        </a>
    ...
    <script src="{{URL::asset('js/apexcharts/apexcharts.js')}}"></script>
