              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{URL::asset('uploads/products/')}}/{{$product->image}}" width="674" height="674" alt="" />
                    <a data-fancybox="gallery" href="{{URL::asset('uploads/products/')}}/{{$product->image}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{URL::asset('uploads/products/')}}/{{$gimg}}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{URL::asset('uploads/products/')}}/{{$product->gimg}}" data-bs-toggle="tooltip"
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{URL::asset('uploads/products/thumbnails/')}}/{{$gimg}}" width="104" height="104" alt="" /></div>
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__addtolinks">
                ...
                <form action="{{route('wishlist.item.remove',['rowId'=>cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId])}}" method="POST" id="form-remove-item">
                    @csrf
                    @method('DELETE')
                <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart"onclick="document.getElementById('form-remove-item').submit();" ><svg width="16" height="16" viewBox="0 0 20 20"
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}">
                  <img loading="lazy" src="{{URL::asset('uploads/products/')}}/{{$product->image}}" width="330" height="400" alt="{{$product->name}}" class="pc__img">
                  @foreach (explode(',',$product->images) as $gimg)
                  <img loading="lazy" src="{{URL::asset('uploads/products/')}}/{{$gimg}}" width="330" height="400"alt="{{$product->name}}" class="pc__img pc__img-second">
                ...
                @else
                    <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                        ...
                        <input type="hidden" name = "name" value="{{$product->name}}">
                        <input type="hidden" name = "price" value="{{$product->sale_price == '' ? $product->regular_price : $product->sale_price }}">
                        <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium "data-aside="cartDrawer" title="Add To Cart">Go To Cart</button>
                     </form>
                 @endif
              </div>
