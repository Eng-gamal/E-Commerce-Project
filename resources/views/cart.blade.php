              ...
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    ...
                    <img loading="lazy" src="{{ URL::asset('/uploads/products/thumbnails/' . $item->model->image) }}" width="120" height="120" alt="{{ $item->name }}" />
                @else
                    <img loading="lazy" src="{{ URL::asset('/images/default-thumbnail.jpg') }}" width="120" height="120" alt="Default Image" />
                @endif
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="qty-control position-relative">
                    ...
                    <form method="POST" action="{{route('cart.qty.decrease',['rowId'=>$item->rowId])}}" style="display:inline;" >
                        @csrf
                        @method('PUT')
                             <div type="submit" class="qty-control__reduce">-</div>
                    </form>

                        <form method="POST" action="{{route('cart.qty.increase',['rowId'=>$item->rowId])}}" style="display:inline;"  >
                            @csrf
                            @method('PUT')
                                 <div type="submit" class="qty-control__increase">+</div>
                        </form>
                  </div>
                </td>
                <td>
