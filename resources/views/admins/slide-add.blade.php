...
<script>
    $(function () {
        $("#myFile").on("change", function () {
            const photoInp = $("#myFile"); // تصحيح الخطأ في استخدام المعرف
            const [file] = this.files;    // الحصول على أول ملف فقط
            if (file) {
                $("#imgpreview img").attr('src', URL.createObjectURL(file)); // تحديث مصدر الصورة
                $("#imgpreview").show(); // إظهار العنصر
            }
        });
    });
</script>
