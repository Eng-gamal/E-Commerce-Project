            ...
            <div class="wg-box">
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div class="item" id="imgpreview" >
                            <img src="{{ URL::asset('uploads/products') }}/{{$product->image}}" class="effect8" alt="{{$product->image}}">
                        </div>
                        @endif
                ...
                <fieldset>
                   ...
                   <div class="item gitems">
                    <img src="{{ URL::asset('uploads/products/thumbnails') }}/{{trim($img)}}" class="effect8" alt="">
                        </div>
                        @endforeach
                        @endif
...
<script>
    $(function() {
        ...
        $("#myFile").on("change", function() {
            const photoInp = $("#myFile"); // Fixed syntax for jQuery selector
        ...
        // Preview gallery upload with multiple images
        $("#gFile").on("change", function() {
            const photoInp = $("#gFile"); // Fixed syntax for jQuery selector
            const gphotos = this.files; // Fixed destructuring syntax for multiple files
    ...
    function StringToSlug(Text) {
        return Text.toLowerCase()
            .replace(/[^\w ]+/g, "") // Fixed regex syntax for special characters
            .replace(/ +/g, "-"); // Fixed regex syntax for spaces
    }
</script>
