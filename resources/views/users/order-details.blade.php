...
<style>
    ...
    .table> :not(caption)>tr>th {
      padding: 0.625rem 1.5rem .25rem !important;
      background-color: #81837c !important;
    }
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="pname">
                                        <div class="image">
                                            <img src="{{URL::asset('uploads/products/thumbnails')}}/{{$item->product->image}}" alt="{{$item->product->name}}" class="image">
                                        </div>
                                        <div class="name">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif ($transaction && $transaction->status =='declinded')
...
<script>
    $(document).ready(function () {
        $('.cancel-order').on('click', function (e) {
            ...
            // الحصول على النموذج الأقرب للزر
            var form = $(this).closest('form');

            // عرض مربع التأكيد باستخدام SweetAlert
            Swal.fire({
                title: "Are you sure?",
