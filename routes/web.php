...
Route::put('/cart/increase-quantity/{rowId}',[CartController::class,'instance_cart_quantity'])->name('cart.qty.increase');
...
Route::middleware(['auth',AuthAdmin::class])->group(function () {
    ...
    Route::delete('admin/brand/{id}/delete', [AdminController::class, 'destroy'])->name('admin.brand.delete');
    //categories
    ...
    Route::delete('admin/category/{id}/delete', [AdminController::class, 'Delete'])->name('admin.category.delete');
